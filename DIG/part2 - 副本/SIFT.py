...
def SIFT(img,showDoGimgs = False):
    ...
    n = 3
    print('getDOG_starttime:',time.time())
    DoG,GuassianPyramid = getDoG(img, n,sigma0)
    print('getDOG_sendtime:', time.time())
    if showDoGimgs:
        for i in DoG:
            for j in i:
